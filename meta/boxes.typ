// Modified from https://github.com/lkoehl/typst-boxes/blob/main/typst-boxes.typ
...
#let colorbox(title: "title", color: none, radius: 2pt, width: auto, body) = {
  ...
  if color == "red" {
    ...
    strokeColor = rgb(247, 163, 7)
    backgroundColor = rgb(255, 229, 181)
  } else if color == "teal" {
    strokeColor = rgb(10, 167, 199)
